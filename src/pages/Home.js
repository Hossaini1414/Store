    ...
    return (
        <div className="bg-white">
            ...
            <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6  bg-white  p-6">
                {products.map((p, index) => (
                    <div key={index} className="bg-[#e0e0e0] rounded-2xl shadow-md  text-center  transition">
                        <img src={p.image} alt={p.title} className=" w-full h-56 object-contain  rounded-md " />
            ...
            <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6  bg-white  p-6">
                {menu.map((m, index) => (
                    <div key={index} className="bg-[#e0e0e0] rounded-2xl shadow-md  text-center  transition">
                        <img src={m.image} alt={m.title} className=" w-full h-56 object-contain  rounded-md " />
            ...
            <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6  bg-white  p-6">
                {brands.map((b, index) => (
                    <div key={index} className="bg-[#e0e0e0] rounded-2xl shadow-md  text-center  transition">
                        <img src={b.image} alt={b.title} className=" w-full h-56 object-contain  rounded-md " />
